...
gcc main.o utils.o myProcess.o heap.o queue.o FCFS.o SJF.o RoundRobin.o -o myprogram

rem Run the compiled program
myprogram

rem Remove the object files and the executable
del utils.o myProcess.o heap.o queue.o FCFS.o SJF.o RoundRobin.o main.o myprogram.exe
